    ...
    methods: {
        ...
        async fetchObjectTypes() {
            ...
            try {
                ...
                // Luôn lọc bỏ USER_EXT và BRANCH để không bao giờ xuất hiện trong việc chọn cho hồ sơ
                this.objectTypes = response.data.filter(t => t.code !== 'USER_EXT' && t.code !== 'BRANCH');
            } catch (error) {
